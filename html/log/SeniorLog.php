        ...
        <div class="container_12">
            <div class="article-box upspace">
                ...
                <div class="post">
                    ...
                    <h2 class="title">
                    	<a href="../show-article/freshshow.php?id=<?php echo $ArticleRow[0]['LogId'];?>&name=<?php $logauthor=$ArticleRow[0]['LogAuthor']; if($logauthor=="") echo "匿名"; else echo $logauthor;?>&grade=4" title="<?php echo $ArticleRow[0]['LogHead'];?>"><?php $loghead=$ArticleRow[0]['LogHead']; if($loghead=="") echo "并没有标题"; else echo $loghead;?></a>
                    </h2>
                    <p class="postmeta">
                    	<span class="author">
                ...
                <div class="post">
                    ...
                    <h2 class="title">
                    	<a href="../show-article/freshshow.php?id=<?php echo $ArticleRow[$x]['LogId'];?>&name=<?php $logauthor=$ArticleRow[$x]['LogAuthor']; if($logauthor=="") echo "匿名"; else echo $logauthor;?>&grade=4" title="<?php echo $ArticleRow[$x]['LogHead'];?>"><?php $loghead=$ArticleRow[$x]['LogHead']; if($loghead=="") echo "并没有标题"; else echo $loghead;?></a>
                    </h2>
                    <p class="postmeta">
                    	<span class="author">
